...
public class PredsGen extends CodeGen {
    ...
    // [ruleName, altIndex]
    private static final MessageFormat fmt = new MessageFormat("public Predicate {0}_pred_{1};// {0} rule pred {1}");
    ...
    public String render(CodeGenContext context) {
        ...
        for (Object[] predInfo : predInfos) {
            ...
            context.fieldPredsMapping.put(ruleName + "_pred_" + altIndex, (Predicate) predInfo[2]);
